@extends('./layouts.bureau.index')

@section('content')
<div class="user-list-container">
    <div class="user-list-header">
        <h2>Liste des demandes</h2>
        <a href="/bureau/ajouter" class="custom-blue-button">
            Ajouter une demande
          </a>
    </div>
    @if (session('status'))
        ...
        <table class="user-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/bureau/demande/edit/{{$demande->id}}" class="action-btn edit"><i class='bx bx-edit-alt'></i></a>
                        <a href="{{ route('demande.renew.bureau', $demande->id) }}" class="action-btn edit"><i class="bi bi-arrow-repeat"></i>
                        </a>
