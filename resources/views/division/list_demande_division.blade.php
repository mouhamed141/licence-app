@extends('./layouts.division.main')

@section('content')
<div class="user-list-container">
    <div class="user-list-header">
        <h2>Liste des demandes</h2>
        <a href="/division/ajouter" class="custom-blue-button">
            Ajouter une demande
          </a>
    </div>
    @if (session('status'))
        ...
        <table class="user-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/division/demande/edit/{{$demande->id}}" class="action-btn edit"><i class='bx bx-edit-alt'></i></a>
                        <a href="{{ route('demande.renew.division', $demande->id) }}" class="action-btn edit"><i class="bi bi-arrow-repeat"></i>
                        </a>
