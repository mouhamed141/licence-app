...
class assistantController extends Controller
{
    ...
    public function view_ajouter_demande_assistant(){

        $zones = Zone::all();

        return view("assistant.ajouter_demande_assistant",compact('zones'));
   }

    public function ajouter_Demande_traitement_assistant(Request $request)
    {
        $request->validate([
            ...
            return redirect('/assistant')->with('status','La demande a bien été ajouté avec succés');
   }


   public function view_modifier_demande_assistant($id) {

    $demandes = Demande::with(['armateur', 'navire', 'zones'])->findOrFail($id);
    $zones = Zone::all();

   return view("assistant.modifier_demande_assistant" , compact("demandes" ,'zones'));
}


public function modifier_Demande_traitement_assistant (Request $request, $id){
    ...
    return redirect('/assistant')->with('status', 'La demande a bien été mise à jour avec succès');
