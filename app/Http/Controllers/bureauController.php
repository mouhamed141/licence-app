...
class bureauController extends Controller
{
    ...
    public function view_ajouter_demande_bureau(){

        $zones = Zone::all();

        return view("bureau.ajouter_demande_bureau",compact('zones'));
   }
    ...
    public function ajouter_Demande_traitement_division(Request $request)
    {
        $request->validate([
            ...
            return redirect('/bureau')->with('status','La demande a bien été ajouté avec succés');
   }


   public function view_modifier_demande_bureau($id) {

    $demandes = Demande::with(['armateur', 'navire' ,'zones'])->findOrFail($id);
    $zones = Zone::all();

   return view("bureau.modifier_demande_bureau" , compact("demandes","zones"));
}


public function modifier_Demande_traitement_bureau (Request $request, $id){
    ...
    return redirect('/bureau')->with('status', 'La demande a bien été mise à jour avec succès');
